...
<html lang="pt-br">
	...
	<body style="padding: 20px;">
        ...
        $arquivo = 'PendentesCesta'.$data_atual.'.xls';

            // Criamos uma tabela HTML com o formato da planilha para excel;
            $tabela = '<div style="padding: 20px;">';
            $tabela .= '<table>';
            $tabela .= '<tr>';
            $tabela .= '<td colspan="3">Tabela de Cestas pendentes '.$data_atual.'</tr>';
            $tabela .= '</tr>';
            $tabela .= '<tr>';
            ...
            $sql = "SELECT `nome_servidor`, `cpf`, `matricula`, `registrado_por`,`recebeu`, `data_hora`, `protocolo` FROM `cestas_entrega` WHERE `recebeu` = 0";
