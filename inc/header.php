...
<meta name="robots" content="noindex" />
  ...
  <meta name="author" content="Diretoria de Tecnologia da Informação - Prefeitura de JacareíksLabs">
  <meta name="keyword" content="">
  <link rel="shortcut icon" href="img/favicon.png">

  <title>Sistema de Entrega de Cesta Básica - Fundação</title>
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index" class="logo">Cesta Básica<span class="lite">  Entrega</span></a>
      <!--logo end-->
