    ...
    <form class="login-form"  action="validacao.php" method="post">
      <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input type="text"  name="usuario" id="txUsuario" class="form-control" placeholder="Login" >
        </div>
        <div class="input-group">
          <span class="input-group-addon"><i class="icon_key_alt"></i></span>
          <input type="password" class="form-control" name="senha" id="txSenha" placeholder="Senha">
        </div>
